...
#ifdef USE_LCD
        unsigned char iptab[4];
        unsigned char iptxt[20];

        iptab[0] = (unsigned char)(IPaddress >> 24);
        iptab[1] = (unsigned char)(IPaddress >> 16);
        iptab[2] = (unsigned char)(IPaddress >> 8);
        iptab[3] = (unsigned char)(IPaddress);
