...
void TouchCalibrate(LcdTouch_t* structure, tDisplay *pDisplay)
{
	...
	put_rectangle(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height, true, ClrBlack);
	box_cache_clean(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height);
	...
	TouchPaintPoint(pDisplay, (((double)pDisplay->Width * (double)12.5) / (double)100), (((double)pDisplay->Height * (double)12.5) / (double)100), ClrRed);
	box_cache_clean(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height);
	...
	TouchPaintPoint(pDisplay, (double)pDisplay->Width - (((double)pDisplay->Width * (double)12.5) / (double)100), (((double)pDisplay->Height * (double)12.5) / (double)100), ClrRed);
	box_cache_clean(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height);
	//CacheDataCleanBuff((unsigned int)&pDisplay->DisplayData + 32, pDisplay->Width * pDisplay->Height * 4);
	Cnt = 0;
	Cnt1 = 0;
	...
	TouchPaintPoint(pDisplay, (double)pDisplay->Width - (((double)pDisplay->Width * (double)12.5) / (double)100), (double)pDisplay->Height - (((double)pDisplay->Height * (double)12.5) / (double)100), ClrRed);
	box_cache_clean(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height);
	//CacheDataCleanBuff((unsigned int)&pDisplay->DisplayData + 32, pDisplay->Width * pDisplay->Height * 4);
	Cnt = 0;
	Cnt1 = 0;
	...
	TouchPaintPoint(pDisplay,  (((double)pDisplay->Width * (double)12.5) / (double)100), (double)pDisplay->Height - (((double)pDisplay->Height * (double)12.5) / (double)100), ClrRed);
	box_cache_clean(pDisplay, 0, 0, pDisplay->Width, pDisplay->Height);
	//CacheDataCleanBuff((unsigned int)&pDisplay->DisplayData + 32, pDisplay->Width * pDisplay->Height * 4);
	Cnt = 0;
	Cnt1 = 0;
