...
#define I2C0_addr (0x48070000)
#define I2C0 (*(i2c_t *) 0x48070000)

#define I2C1_addr (0x48072000)
#define I2C1 (*(i2c_t *) 0x48072000)

#define I2C2_addr (0x48060000)
#define I2C2 (*(i2c_t *) 0x48060000)

#define I2C3_addr (0x48350000)
#define I2C3 (*(i2c_t *) 0x48350000)
