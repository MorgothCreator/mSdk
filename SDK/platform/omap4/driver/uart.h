...
typedef volatile unsigned int _UART_IrDA_CIR_;
...
unsigned int UARTRegConfigModeEnable(unsigned int baseAdd,
                                     unsigned int modeFlag);
void UARTRegConfModeRestore(unsigned int baseAdd,
...
void UARTXONAnyFeatureControl(unsigned int baseAdd,
                                     unsigned int controlFlag);
...
/*typedef struct
{
	_UART_IrDA_CIR_ UART_THR_UART_RHR_UART_DLL;//0x00
	_UART_IrDA_CIR_ UART_IER_UART_DLH;//0x04
	_UART_IrDA_CIR_ UART_IIR_UART_FCR_UART_EFR;//0x08
	_UART_IrDA_CIR_ UART_LCR;//0x0C
	_UART_IrDA_CIR_ UART_XON1_ADDR1_UART_MCR;//0x10
	_UART_IrDA_CIR_ UART_LSR_UART_XON2_ADDR2;//0x14
	_UART_IrDA_CIR_ UART_TCR_UART_XOFF1_UART_MSR;//0x18
	_UART_IrDA_CIR_ UART_SPR_UART_TLR_UART_XOFF2;//0x1C
	_UART_IrDA_CIR_ UART_MDR1;//0x20
	_UART_IrDA_CIR_ UART_MDR2;//0x24
	_UART_IrDA_CIR_ UART_SFLSR_UART_TXFLL;//0x28
	_UART_IrDA_CIR_ UART_RESUME_UART_TXFLH;//0x2C
	_UART_IrDA_CIR_ UART_SFREGL_UART_RXFLL;//0x30
	_UART_IrDA_CIR_ UART_SFREGH_UART_RXFLH;//0x34
	_UART_IrDA_CIR_ UART_BLR_UART_UASR;//0x38
	_UART_IrDA_CIR_ UART_ACREG;//0x3C
	_UART_IrDA_CIR_ UART_SCR;//0x40
	_UART_IrDA_CIR_ UART_SSR;//0x44
	_UART_IrDA_CIR_ UART_EBLR;//0x48
	_UART_IrDA_CIR_ UART_RESERVED_0x4C;//0x4C
	_UART_IrDA_CIR_ UART_MVR;//0x50
	_UART_IrDA_CIR_ UART_SYSC;//0x54
	_UART_IrDA_CIR_ UART_SYSS;//0x58
	_UART_IrDA_CIR_ UART_WER;//0x5C
	_UART_IrDA_CIR_ UART_CFPS;//0x60
	_UART_IrDA_CIR_ UART_RXFIFO_LVL;//0x64
	_UART_IrDA_CIR_ UART_TXFIFO_LVL;//0x68
	_UART_IrDA_CIR_ UART_IER2;//0x6C
	_UART_IrDA_CIR_ UART_ISR2;//0x70
	_UART_IrDA_CIR_ UART_FREQ_SEL;//0x74
	_UART_IrDA_CIR_ UART_RESERVED_0x78;//0x78
	_UART_IrDA_CIR_ UART_RESERVED_0x7C;//0x7C
	_UART_IrDA_CIR_ UART_MDR3;//0x80
	_UART_IrDA_CIR_ UART_TX_DMA_THRESHOLD;//0x84
}UART_IrDA_CIR_t;*/


#define SOC_UART_0_REGS 0x4806A000
#define SOC_UART_1_REGS 0x4806C000
#define SOC_UART_2_REGS 0x48020000
#define SOC_UART_3_REGS 0x4806E000

#define UART0 (*(UART_IrDA_CIR_t *) 0x4806A000)
#define UART1 (*(UART_IrDA_CIR_t *) 0x4806C000)
#define UART2 (*(UART_IrDA_CIR_t *) 0x48020000)
#define UART3 (*(UART_IrDA_CIR_t *) 0x4806E000)
