 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */
  ...
  #define HSE_Value    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
    ...
    #if ( HSE_VALUE != 4000000 ) && (HSE_VALUE != 8000000 )
     #error "only prepared for 4Mhz and 8MHz"
   #else
    #define HSE_Value    ((uint32_t)HSE_VALUE) /*!<Value of Ext. osc. in Hz passed as preproc.-define */
   #endif /* HSE_VALUE check */
  #else
