 ...
 *
 * This file contains the _main buffer controller for compression.
 * The _main buffer lies between the pre-processor and the JPEG
			  ...
			  JDIMENSION in_rows_avail)
{
  ...
  while (_main->cur_iMCU_row < cinfo->total_iMCU_rows) {
    ...
    if (_main->rowgroup_ctr < (JDIMENSION) cinfo->min_DCT_v_scaled_size)
     ...
     * call suspended; then mark the _main buffer empty.
     */
    if (_main->suspended) {
      (*in_row_ctr)++;
      _main->suspended = FALSE;
...
jinit_c_main_controller (j_compress_ptr cinfo, boolean need_full_buffer)
{
  ...
  cinfo->_main = (struct jpeg_c_main_controller *) _main;
