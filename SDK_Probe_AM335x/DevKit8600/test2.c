...
/*******************************************************/
...
#endif
	put_rectangle(BackScreen, 0, 0, ScreenBuff->Width, ScreenBuff->Height, true, controls_color.Scren);
    ...
    /* Set Y position of window to default screen position + 10 */
    //MainWindow->PositionFullScreen.Y += 20;
    /* Set Y size of window to Y screen size - 90 (position 20 + down space 70 */
    //MainWindow->SizeFullScreen.Y -= 90;
    /* Set the limits to move window */
    MainWindow->WindowMoveLimits.sXMin = 0;
    MainWindow->WindowMoveLimits.sXMax = ScreenBuff->Width;
    MainWindow->WindowMoveLimits.sYMin = 20;
    MainWindow->WindowMoveLimits.sYMax = ScreenBuff->Height - 70;
    ...
    /* Alloc and create a virtual keyboard */
    Kbd = new_v_keyboard(BackScreen);
    /* Set location and size of virtual keyboard */
    Kbd->Position.X = 0;
    Kbd->Position.Y = ScreenBuff->Height - 70;
    Kbd->Size.X = ScreenBuff->Width;
    Kbd->Size.Y = 70;
