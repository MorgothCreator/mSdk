...
/*-----------------------------------------------------*/
/* Set up the Twi 0 to communicate with all on-board I2C devices */
	TWI[AUDIO_LCD_I2C_UNIT] = new_(new_twi);
	INIT_TWI(AUDIO_LCD_I2C_UNIT, 100000, AUDIO_LCD_I2C_SCL_PORT, AUDIO_LCD_I2C_SCL_PIN, AUDIO_LCD_I2C_SDA_PORT, AUDIO_LCD_I2C_SDA_PIN, 256, 256);
/*-----------------------------------------------------*/
